...
示例:
  ./process_multiple_files_parallel.sh --input_dir input_dir --index_file b.txt --output_dir output_dir --threads 4 --plus 5
示例:
...
# 去除 b 文件中的多余空格并清理括号
clean_index_file="${index_file}_clean"
sed -e 's/[()]//g' -e 's/ //g' "$index_file" > "$clean_index_file"
index_file="$clean_index_file"
echo "已去除多余空格和括号，生成文件: $index_file"
